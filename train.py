...
def get_args():
    ...
    parser.add_argument("--input", "-i", type=str, required=True, help="path to input database mat file")
    parser.add_argument("--dataset_path", type=str, required=True, help="path to input database directory")
    parser.add_argument("--batch_size", type=int, default=32, help="batch size")
    parser.add_argument("--nb_epochs", type=int, default=70, help="number of epochs")
